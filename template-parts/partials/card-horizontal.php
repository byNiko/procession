...
?>
		<div class="card <?php echo get_post_type($p); ?>--card is-horizontal row">
			...
			<div class="column d-flex justify-center direction-column">
				<header class="card--header <?php echo get_post_type($p); ?>--header <?php echo get_post_type($p); ?>--card-header">
					<a href="<?php echo $f['link']['url']; ?>">
				...
				<div class="card--link-wrapper <?php echo get_post_type(); ?>--link-wrapper mt-2">
					<a class="card--link <?php echo get_post_type($p); ?>--link learn-more button button-primary button-hollow" href="<?php echo $f['link']['url']; ?>">
						Learn More
					</a>
				</div>
			</div>
	...
	?>
		<div class="card <?php echo get_post_type($p); ?>--card is-horizontal row">
			...
			<div class="column d-flex justify-center direction-column">
				<header class="card--header <?php echo get_post_type($p); ?>--header <?php echo get_post_type($p); ?>--card-header">
					<a href="<?php the_permalink($p); ?>">
						<?php procession_the_event_header($p); ?>
					</a>
				</header>
				<div class="card--link-wrapper <?php echo get_post_type(); ?>--link-wrapper mt-2">
					<a class="card--link <?php echo get_post_type($p); ?>--link learn-more button button-primary button-hollow" href="<?php the_permalink($p); ?>">
						Learn More
					</a>
				</div>
			</div>
